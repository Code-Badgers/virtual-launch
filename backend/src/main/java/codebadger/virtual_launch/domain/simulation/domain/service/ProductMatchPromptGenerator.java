...
@Component
public class ProductMatchPromptGenerator {
    ...
    public String generate(String targetSpecJson, String competitorSpecJson) {
        return String.format(MATCH_PROMPT_TEMPLATE, targetSpecJson, competitorSpecJson);
    }
}
